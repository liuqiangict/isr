...
class DRLM(nn.Module):
    def __init__(self, args, chs, scale):
...
class DenseBlock_3(nn.Module):
    def __init__(self, args, chs):
        super(DenseBlock_3, self).__init__()
        body = [DRLM(args, chs, i) for i in range(2, 5)]
...
class DenseBlock_4(nn.Module):
    def __init__(self, args, chs):
        ...
        body = [DRLM(args, chs, i) for i in range(2, 6)]
        self.body = nn.Sequential(*body)
...
class DRLN(nn.Module):
    def __init__(self, args):
        ...
        body_1 = [DenseBlock_3(args, chs) for _ in range(self.n_resblocks_3)]
        body_2 = [DenseBlock_4(args, chs) for _ in range(self.n_resblocks_4)]
